...
export const dockItems: DockItemProps[] = [
  {
    ...
    children: <Profile />,
    className: 'col-span-2 sm:col-span-2 md:col-span-3 lg:col-span-6 xl:col-span-4',
  },

  {
    ...
    className: 'col-span-1 sm:col-span-1 lg:col-span-3 xl:col-span-2 overflow-hidden',
  },
  {
    id: 'kontak',
    name: 'Kontak',
  ...
  
  {
    ...
    className: 'col-span-2 sm:col-span-2 md:col-span-3 xl:col-span-8',
  },
  {
    id: 'project',
    name: 'Project',
