...
export const multiLangUIText: Record<string, MultiLangText> = {
  ...
  techstack:{
    ...
    zh: '技术栈概览',
    ko: '기술 스택 개요',
    es: 'Resumen de Tech Stack',
    fr: 'Aperçu de la pile technologique',
    de: 'Tech-Stack-Übersicht',
    ar: 'نظرة عامة على مجموعة التقنيات',
  ...
  renderTime:{
    ...
    fr: 'Temps de rendu : 4ms',
    de: 'Renderzeit: 4ms',
    ar: 'وقت العرض: 4 مللي ثانية',
