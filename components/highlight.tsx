...
export const Highlight = ({title, label, className}: HighlightProps) => {
    return ( 
        <div className={clsx(' px-1.5 rounded-xl bg-white/10 border border-white/20 shadow-2xl', className)}>
            <span className="relative flex sm:flex-col justify-center items-center">
