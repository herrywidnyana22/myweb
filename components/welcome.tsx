  ...
  const onMouseMove = (e: MouseEvent) => {
    ...
    letters.forEach(letter => {
      ...
      const distance = Math.abs(
        mouseX - (letterLeft - containerLeft + width / 2)
      );
...
export const Welcome = () => {
  ...
  if (!isMounted) {
    return (
      <section
        ref={sectionRef}
        className='fixed inset-0 flex items-center justify-center overflow-auto px-4 py-8 select-none sm:px-6'
      >
        <div className='flex w-full max-w-5xl flex-col justify-center gap-2 text-center text-gray-200 sm:gap-3 md:gap-4'>
          <p className='text-xs leading-relaxed text-gray-400 sm:text-sm md:text-base lg:text-lg'>
            <span className='font-georama inline-block text-xs opacity-0 sm:text-sm md:text-base lg:text-lg'>
              Loading...
            </span>
          </p>
          <h1>
            <span className='font-georama inline-block text-xl leading-tight italic opacity-0 sm:text-3xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl'>
              Loading...
            </span>
          </h1>
        </div>
  ...
  return (
    ...
    >
      <div className='flex w-full max-w-5xl flex-col justify-center gap-2 text-center text-gray-200 sm:gap-3 md:gap-4'>
        <p
          ref={subTitleRef}
          className='text-xs leading-relaxed text-gray-300 sm:text-sm md:text-base lg:text-lg'
        >
          <TextRender
            text={welcomeText}
            weight={100}
            className='font-georama inline-block text-xs sm:text-sm md:text-base lg:text-lg'
          />
        </p>
        ...
        <h1 ref={titleRef}>
          <TextRender
            text={welcomeTitle}
            className='font-georama inline-block text-xl leading-tight italic sm:text-3xl md:text-5xl'
          />
        </h1>
      </div>
    </section>
