...
export const UrlField = ({
    ...
    label = "URL",
    placeholder = "https://...",
}: Pick<CommonFieldsProps, 'formData' | 'isLoading' | 'onChange'> & { label?: string; placeholder?: string }) => (
    <FormInput
        label={label}
        value={formData.href || ''}
...
export const SubtitleAndDescriptionFields = ({
    ...
    getLanguageInfo,
    onMultiLangChange,
}: Omit<CommonFieldsProps, 'errors' | 'isUploadingIcon' | 'onIconUpload' | 'onIconRemove' | 'onChange'>) => (
    <>
        <MultiLangInput
            label="Subtitle"
