  ...
  return (
    <div className='bg-opacity-50 fixed inset-0 z-50 flex items-center justify-center bg-black p-4'>
      <div className='max-h-[90vh] w-full max-w-md overflow-y-auto rounded-lg bg-white shadow-xl'>
        <ModalHeader title={title} onClose={onClose} disabled={isLoading} />
          ...
          {isProject && formData.fileType === 'PROJECT_INFO' && (
            <>
              ...
              <Notice
                text={
                  <>
                    <strong>Note:</strong> Project data (Tech Stack, Progress,
                    Description) will be automatically populated from the
                    project. The project icon will be saved to subIcon field.
                  </>
                }
              />
            </>
          ...
          {!isProject && formData.fileType === 'CONTACT' && (
            <>
              ...
              <Notice
                text={
                  <>
                    <strong>Note:</strong> The list above shows available
